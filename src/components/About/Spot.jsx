...
const Spot = () =>{
    ...
    return(
        <motion.div 
         ...
         >
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-14 bottom-12' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-8 top-56' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-64 top-56' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-60 bottom-12' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-80 bottom-24' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-24 top-48' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-2 top-80' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path fill="#FA4D56" d="M11.7,-32.9C14.9,-18.4,17.1,-14.7,18.9,-11.1C20.7,-7.4,22,-3.7,19.5,-1.5C17,0.8,10.5,1.6,12.7,12.2C15,22.8,25.9,43.3,25.2,47.4C24.5,51.5,12.3,39.2,6,28.9C-0.3,18.5,-0.6,10.1,-13.1,12.8C-25.6,15.5,-50.3,29.4,-62.6,29.1C-74.8,28.9,-74.6,14.4,-74.2,0.2C-73.9,-14,-73.4,-28.1,-62.6,-30.8C-51.7,-33.5,-30.5,-24.8,-18.4,-34.2C-6.2,-43.6,-3.1,-71.1,0.6,-72.1C4.2,-73.1,8.5,-47.5,11.7,-32.9Z" transform="translate(100 100)" />
            </motion.svg>
            <motion.svg variants={item} initial='hidden' animate={controls} ref={ref} className='absolute w-8 left-80 bottom-44' viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path fill="#BB0066" d="M39.2,-59.2C49.6,-61.9,55.9,-48.9,64.5,-36.5C73,-24,83.8,-12,79.5,-2.4C75.3,7.1,56.1,14.2,42.7,18.2C29.2,22.2,21.6,23.2,15.4,30.1C9.3,37.1,4.6,50,-3.2,55.5C-11,61,-21.9,59,-34.6,55.8C-47.3,52.6,-61.6,48.2,-58.6,38.7C-55.5,29.2,-35.1,14.6,-36.2,-0.6C-37.3,-15.9,-60,-31.8,-63.4,-41.9C-66.8,-52,-50.8,-56.2,-37,-51.4C-23.2,-46.7,-11.6,-33.1,1.4,-35.5C14.4,-37.9,28.8,-56.4,39.2,-59.2Z" transform="translate(100 100)" />
            </motion.svg>
         </motion.div>
    )

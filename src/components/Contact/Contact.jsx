...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_dr7klx1', 'template_gyqx38j', form.current, 'GcBXWZAepSFDdHCbh')
        .then((result) => {
    ...
    <div className="mb-20 text-center" id="contact" >
      ...
      <div className="bg-gradient-to-r from-[#8f145d] to-[#bd4a4a] inline-block mb-6 center">
        ...
        <div className="md:w-8/12 w-full mx-auto">
            ...
            <p className='text-xl text-neutral-200 mb-5'>My Email: <span className='italic text-sm text-neutral-400'>kishan2882001@gmail.com</span></p>

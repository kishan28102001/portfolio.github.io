...
const Pass_js = require("three-stdlib");
...
class $87431ee93b037844$export$2489f9981ab0fa82 extends postprocessing.Pass {
  ...
  constructor(scene, camera, width = 512, height = 512) {
    ...
    this.effectCompisterQuad = new Pass_js.FullScreenQuad(new THREE.ShaderMaterial($12b21d24d1192a04$export$a815acccbd2c9a49));
    this.copyQuad = new Pass_js.FullScreenQuad(new THREE.ShaderMaterial({
      uniforms: {
        tDiffuse: {
          value: null
        }
  ...
  configureAOPass(logarithmicDepthBuffer = false) {
    ...
    if (this.effectShaderQuad) {
      ...
      this.effectShaderQuad = new Pass_js.FullScreenQuad(new THREE.ShaderMaterial(e));
  }
  configureDenoisePass(logarithmicDepthBuffer = false) {
    ...
    if (this.poissonBlurQuad) {
      ...
      this.poissonBlurQuad = new Pass_js.FullScreenQuad(new THREE.ShaderMaterial(p));
  }
  /**
       * 
       * @param {Number} n 
